...
export default function CampaignShop() {
  return (
    <section id="campaign-shop" className="relative py-16 pb-[72px] bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-7">
          <p className="font-montserrat text-[10px] tracking-[.40em] uppercase mb-[6px] campaign-label-color">Fragrance Edit</p>
          <h2 className="font-cormorant font-light tracking-[.05em] text-[#1a1410] m-0 campaign-title">Shop the Campaign</h2>
        </div>
        ...
        <div className="grid grid-cols-3 gap-[18px] max-[992px]:gap-[14px] max-[768px]:grid-cols-1">
          {campaignItems.map((item, i) => (
            ...
            >
              <div className="relative w-full overflow-hidden campaign-img-bg" style={{ aspectRatio: '4/5' }}>
                <img
                  src={item.img}
                  alt={item.alt}
