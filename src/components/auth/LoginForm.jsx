      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          ...
          <input
            type="password"
            {...register('password')}
            className={`w-full bg-[#140e0b] border ${errors.password ? 'border-[#e35f5f]' : 'border-[#b39874]/30'} focus:border-[#d4af37] text-white px-4 py-3 text-xs tracking-wider outline-none transition-all duration-300`}
            placeholder="••••••••"
          />
          {errors.password && (
